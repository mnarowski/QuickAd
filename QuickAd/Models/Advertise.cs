...
namespace QuickAd.Models {
	public class Advertise {
        ...
        [Display(Name = "Treœæ"), Required, MinLength(10),DataType(DataType.MultilineText)]
        public virtual string Vcontent {get { return this.Content; } set { this.Content = value; }}
        [Display(Name = "Data wa¿noœci"),DataType(DataType.DateTime)]
        ...
        [Display(Name = "Informacje dodatkowe"),DataType(DataType.MultilineText)]
